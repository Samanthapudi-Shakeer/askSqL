...
export const ChatMessages = ({ messages, isLoading, tabularMode }: ChatMessagesProps) => {
          ...
          {messages.map((message, index) => (
            ...
            >
              <div className={`max-w-4xl w-full rounded-2xl ${
                message.role === 'user'
                  ? 'bg-gradient-to-r from-blue-600 to-purple-600 p-5 shadow-xl hover:shadow-2xl transition-all duration-200 text-white'
                  : 'bg-white/95 backdrop-blur-lg border border-gray-100/50 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-200'
              }`}>
                    ...
                    <div className="p-4 pb-10">
                      {(() => {
                        ...
                        return (
                          ...
                          <pre className="relative group rounded-lg p-4 overflow-x-auto bg-white/60">
